...
enum BitMask : uint64_t
{
    ...
    CASTLING_KS_WHITE = 0b1000,
    CASTLING_QS_WHITE = 0b0100,
    CASTLING_KS_BLACK = 0b0010,
    CASTLING_QS_BLACK = 0b0001,

    PROMOTION_RANK = RANK_1 | RANK_8
};

inline uint64_t getSquareBitmask(int rank, int file)
{
